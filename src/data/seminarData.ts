...
export const SPEAKERS: Speaker[] = [
  ...
  {
    id: 'hisashi-matsuda',
    name: 'Mr. Hisashi Matsuda',
    nameJa: '松田 久 氏',
    role: 'Chairman',
    roleJa: '会長',
    badge: 'Special Guest',
    organization: 'The Okayama Chamber of Commerce and Industry',
    organizationJa: '岡山商工会議所',
    category: 'business',
    bio: 'Prominent Japanese business executive and Chairman of the Okayama Chamber of Commerce and Industry. Actively involved in local development projects and fostering business partnerships in Okayama.',
    bioJa: '著名な日本の経営者であり、岡山商工会議所会頭。岡山での地域開発プロジェクトやビジネスパートナーシップの促進に積極的に取り組んでいる。',
    topic: 'Fostering Business Partnerships and Economic Growth in Okayama',
    topicJa: '岡山におけるビジネスパートナーシップと経済成長の促進',
  ...
  },
  {
    ...
    roleJa: '会長',
    badge: 'Special Guest',
    organization: 'MORI Educational Foundation, Okayama Gakugeikan High School',
    organizationJa: '森教育学園、岡山学芸館高等学校',
    category: 'education',
    bio: 'Chairman of MORI Educational Foundation and Okayama Gakugeikan High School. A distinguished leader dedicated to fostering international educational exchange and youth development between Okayama and Bangladesh.',
    bioJa: '森教育学園および岡山学芸館高等学校の理事長。岡山とバングラデシュ間の国際的な教育交流と青少年育成の促進に尽力する著名なリーダー。',
    topic: 'Fostering International Educational Exchange and Youth Development',
    topicJa: '国際的な教育交流と青少年育成の促進',
